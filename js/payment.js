...
Object.assign(App.payment, {
    ...
    openSplitModal: async (comandaId, items, numeroMesa) => {
        ...
        const taxaAmount = (checkModal && checkModal.checked) ? subtotalTaxavel * 0.10 : 0;
        App.state.comandaTaxa = taxaAmount;
    ...
    finalizeSplit: async () => {
        ...
        const taxaServico = App.state.comandaTaxa || 0;
        ...
        const { data: newOrder } = await _sb.from('orders').insert({
            ...
            total_pago: total,
            taxa_servico: taxaServico,            // 🔥 ADICIONADO PARA RELATÓRIO DE COMISSÕES
